...
pixelMatrix[0][4] = (	255	,	255	,	255	)
pixelMatrix[1][0] = (	0	,	0	,	0	)
pixelMatrix[1][1] = (	0	,	0	,	0	)
pixelMatrix[1][2] = (	255	,	255	,	255	)
pixelMatrix[1][3] = (	0	,	0	,	0	)
pixelMatrix[1][4] = (	255	,	255	,	255	)
pixelMatrix[2][0] = (	0	,	0	,	0	)
pixelMatrix[2][1] = (	255	,	255	,	255	)
pixelMatrix[2][2] = (	255	,	255	,	255	)
pixelMatrix[2][3] = (	0	,	0	,	0	)
pixelMatrix[2][4] = (	255	,	255	,	255	)
pixelMatrix[3][0] = (	0	,	0	,	0	)
pixelMatrix[3][1] = (	255	,	255	,	255	)
pixelMatrix[3][2] = (	0	,	0	,	0	)
pixelMatrix[3][3] = (	0	,	0	,	0	)
pixelMatrix[3][4] = (	255	,	255	,	255	)
pixelMatrix[4][0] = (	0	,	0	,	0	)
pixelMatrix[4][1] = (	0	,	0	,	0	)
pixelMatrix[4][2] = (	0	,	0	,	0	)
pixelMatrix[4][3] = (	0	,	0	,	0	)
pixelMatrix[4][4] = (	0	,	0	,	0	)
